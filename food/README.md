...
I use this space to write down, organize, and improve the recipes I actually cook.  They have to be healthy and they have to taste.

---

## My approach

- 🥦 **Vegetarian** → all recipes are meat-free.  
- 💪 **High protein** → I focus on plant-based protein sources to support my training and active lifestyle.  
- ❤️ **Healthy & practical** → meals that are nutritious but also easy to prepare.  
- 🧬 **Microbiota-friendly (exceptions)** → some recipes (e.g. potato-based ones) are not high in protein but are kept because they play a role in maintaining a healthy gut microbiota.  
